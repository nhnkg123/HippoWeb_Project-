...
const perks = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: 'Every assets on our platform is verified by our team to ensure our highest quality standard. Not happy? We offer a 30-day refund guarantee.'
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
    description: 'We pledged 1% of sales to the preservation and restoration of the natural environment.'
  },
];
      ...
      <MaxWidthWrapper className="">
        <div className="py-20 max-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            ...
            verified by our team to ensure our highest quality standrad.
          </p>
